					...
					<div className='grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto'>
						{[
							...
							>
								...
								<div
									className={`h-1 w-16 bg-gradient-to-r ${feature.gradient} rounded-full group-hover:w-24 transition-all duration-300`}
								></div>
							</div>
						))}
					</div>
								...
								<div className='grid md:grid-cols-2 gap-6 mb-8'>
									<div className='bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20'>
										...
										<p className='text-white/90'>
											Dial *565# to instantly activate your availability status
											on the PayHold platform
										</p>
									</div>
									<div className='bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20'>
										<div className='text-3xl mb-3'>🔄</div>
										...
										<p className='text-white/90'>
											Automatic rotation system ensures fair job distribution
											among all active dispatchers
										</p>
									</div>
									<div className='bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20'>
										<div className='text-3xl mb-3'>💵</div>
										...
										<p className='text-white/90'>
											Earn competitive rates for every delivery with weekly
									...
									<div className='bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20'>
										...
										<p className='text-white/90'>
											Quality service leads to better ratings, which means more
					...
					<div className='grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12'>
						...
						<div className='lg:col-span-1'>
							...
							<div className='flex gap-4'>
								...
								<a
									href='#'
									className='w-10 h-10 bg-gray-800 hover:bg-[#1a7a4a] rounded-lg flex items-center justify-center transition-colors'
								>
									<svg
										className='w-5 h-5'
										fill='currentColor'
						...
						<div>
							...
							<ul className='space-y-3 text-gray-400'>
								<li className='flex items-start gap-2'>
									<svg
										className='w-5 h-5 text-[#1a7a4a] mt-0.5'
										fill='none'
										stroke='currentColor'
										viewBox='0 0 24 24'
									>
